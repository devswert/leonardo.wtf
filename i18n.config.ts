  ...
  messages: {
    en: {
      ...
      aboutMe: {
        title: "About Me",
        firstParagraph:
          "I'm a software engineer with 10 years of experience. I started working when I was 18, and during this time I've learned and grown in distinct scopes, from understanding what software engineering itself is to the importance of being part of a company where I share their mission/vision.",
        secondParagraph:
    ...
    es: {
      ...
      aboutMe: {
        title: "Sobre Mi",
        firstParagraph:
          "Soy un ingeniero de software con 10 años de experiencia. Empecé a trabajar cuando tenía 18 años, y durante este tiempo he aprendido y crecido en distintos ámbitos, desde comprender qué es la ingeniería de software, a entender lo importante que es formar parte en una compañía en la que comparto su misión/visión.",
        secondParagraph:
        ...
        sideProjets: [
          {
            ...
            date: "Present",
            description:
              "No está en producción aún, pero es un e-commerce para la tienda Rocota, una marca que crea hermosas piezas de cerámica hechas a mano. Está siendo construido con Shopify.",
            tools: ["css", "shopify"],
          },
          {
            company: "Tomaton",
